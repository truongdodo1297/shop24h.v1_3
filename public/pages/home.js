...
const Home = () => {
    ...
    return (
        <Row >
            {/* <Row className="Nav_Icon" >
                <Col className="iconPhone" xs="2">
                    <PhoneIphoneIcon style={{ fontSize: "45px" }} />
                    <p>iPhone 14 Pro</p>
                </Col>
                <Col className="iconPhone" xs="2">
                    <PhoneAndroidIcon style={{ fontSize: "45px" }} />
                    <p>iPhone 14</p>
                </Col>
                <Col className="iconPhone" xs="2">
                    <SmartphoneIcon style={{ fontSize: "45px" }}></SmartphoneIcon>
                    <p>iPhone 13</p>
                </Col>
                <Col className="iconPhone" xs="2">
                    <AdUnitsIcon style={{ fontSize: "45px" }}></AdUnitsIcon>
                    <p>iPhone SE</p>
                </Col>
                <Col className="iconPhone" xs="2">
                    <TripOriginIcon style={{ fontSize: "45px" }} ></TripOriginIcon>
                    <p>AirTag</p>
                </Col>
                <Col className="iconPhone" xs="2">
                    <HeadphonesIcon style={{ fontSize: "45px" }} onClick={() => { goToProduct() }}></HeadphonesIcon>
                    <p>HeadPhone</p>
                </Col>
            </Row> */}
